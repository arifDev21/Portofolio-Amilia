				...
				<div className="flex flex-col md:flex-row">
					...
					<div className="md:w-full flex flex-col justify-between">
						<p
						    ...
						    As a recent graduate with a Bachelor's degree in Informatics Engineering,
							I am highly enthusiastic about exploring and advancing in the fields of frontend development and graphic design. 
							Throughout my academic journey, I have been involved in various projects focusing on creating engaging 
							user interfaces and intuitive user experiences. My skills in JavaScript frameworks such as React.js, 
							combined with a deep understanding of graphic design tools like Adobe Photoshop and Figma, 
							enable me to craft visually appealing and functional solutions. 
							I am committed to continuing my growth in these areas and am excited about the opportunity to contribute creatively
							 and technically to a dynamic team.
						</p>
